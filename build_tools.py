...
def compile_files_ext(build_dir: str, src_dir: str, flags: str, extension: str, func: Callable[[str, str, str], int]) -> bool:
...
def compile_files(build_dir: str, src_dir: str, flags: str, extension: str, files_to_compile: list[str], func: Callable[[str, str, str], int]) -> bool:
    if files_to_compile: 
        trace(f'compiling {extension} files')
    else:
        return False
